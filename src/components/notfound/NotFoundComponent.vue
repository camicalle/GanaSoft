    ...
    <div>
        <div class="bg-gray-200 w-full px-16 md:px-0 h-screen flex items-center justify-center">
            <div
                ...
                <p class="text-2xl md:text-3xl lg:text-5xl text-center font-bold tracking-wider text-gray-500 mt-4">Pagina
                    no encontrada</p>
                <p class="text-gray-500 mt-4 pb-4 border-b-2 text-center">Lo sentimos, no se ha encontrado la página que
                    busca.</p>
                <a href="/"
