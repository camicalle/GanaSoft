...
<template>
    <div>
        ...
        <div class="p-2 shadow">
            <div class="text-end">
                <button
                    class="text-gray-500 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap" @click="logout">Cerrar Sesión</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a href="#"
