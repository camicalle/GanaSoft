        ...
        >
          <div class="relative w-full max-w-2xl max-h-full">
            ...
            >
              <!-- Modal header -->
              <div
                class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600 bg-green-700"
              >
                <h3 class="text-xl text-white font-semibold dark:text-white">Agregar Animal</h3>
                <button
                  @click.prevent="close"
                  type="button"
